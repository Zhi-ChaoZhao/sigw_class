//gcc -O3 -fopenmp -g -fPIC -D__CLASSDIR__='"/workspace/Ubuntu/SGWBxCMB/class_public"' -DHYREC -I../include -I../external/RecfastCLASS -I../external/heating -I../external/HyRec2020 -c fNLgNLhNL.c -o ../FNLGNLHNLFunctions/fNLgNLhNL.o; gcc -O3 -fopenmp -g -fPIC -D__CLASSDIR__='"/workspace/Ubuntu/SGWBxCMB/class_public"' -DHYREC -I../include -I../external/RecfastCLASS -I../external/heating -I../external/HyRec2020 -c omega_functions.c -o ../FNLGNLHNLFunctions/omega_functions.o
#include <stdio.h>
#include <math.h>
