...
void spline_function_initial_all() {
    initialize_accel();
    spline_B = load_data(&Data_B, "./dat/B.dat");
    spline_Omega_G = load_data(&Data_Omega_G, "./dat/Omega_G.dat");
    spline_Omega_H = load_data(&Data_Omega_H, "./dat/Omega_H.dat");
    spline_Omega_H2 = load_data(&Data_Omega_H2, "./dat/Omega_H2.dat");
    spline_Omega_H3 = load_data(&Data_Omega_H3, "./dat/Omega_H3.dat");
    spline_Omega_R = load_data(&Data_Omega_R, "./dat/Omega_R.dat");
    spline_Omega_RH = load_data(&Data_Omega_RH, "./dat/Omega_RH.dat");
    spline_Omega_RH2 = load_data(&Data_Omega_RH2, "./dat/Omega_RH2.dat");
    spline_Omega_R2 = load_data(&Data_Omega_R2, "./dat/Omega_R2.dat");
    spline_Omega_R2H = load_data(&Data_Omega_R2H, "./dat/Omega_R2H.dat");
    spline_Omega_R3 = load_data(&Data_Omega_R3, "./dat/Omega_R3.dat");
    spline_Omega_C = load_data(&Data_Omega_C, "./dat/Omega_C.dat");
    spline_Omega_CH = load_data(&Data_Omega_CH, "./dat/Omega_CH.dat");
    spline_Omega_CH2 = load_data(&Data_Omega_CH2, "./dat/Omega_CH2.dat");
    spline_Omega_CR = load_data(&Data_Omega_CR, "./dat/Omega_CR.dat");
    spline_Omega_CRH = load_data(&Data_Omega_CRH, "./dat/Omega_CRH.dat");
    spline_Omega_CR2 = load_data(&Data_Omega_CR2, "./dat/Omega_CR2.dat");
    spline_Omega_C2 = load_data(&Data_Omega_C2, "./dat/Omega_C2.dat");
    spline_Omega_C2H = load_data(&Data_Omega_C2H, "./dat/Omega_C2H.dat");
    spline_Omega_C2R = load_data(&Data_Omega_C2R, "./dat/Omega_C2R.dat");
    spline_Omega_C3 = load_data(&Data_Omega_C3, "./dat/Omega_C3.dat");
    spline_Omega_Z = load_data(&Data_Omega_Z, "./dat/Omega_Z.dat");
    spline_Omega_ZH = load_data(&Data_Omega_ZH, "./dat/Omega_ZH.dat");
    spline_Omega_ZH2 = load_data(&Data_Omega_ZH2, "./dat/Omega_ZH2.dat");
    spline_Omega_ZR = load_data(&Data_Omega_ZR, "./dat/Omega_ZR.dat");
    spline_Omega_ZRH = load_data(&Data_Omega_ZRH, "./dat/Omega_ZRH.dat");
    spline_Omega_ZR2 = load_data(&Data_Omega_ZR2, "./dat/Omega_ZR2.dat");
    spline_Omega_Z2 = load_data(&Data_Omega_Z2, "./dat/Omega_Z2.dat");
    spline_Omega_Z2H = load_data(&Data_Omega_Z2H, "./dat/Omega_Z2H.dat");
    spline_Omega_Z2R = load_data(&Data_Omega_Z2R, "./dat/Omega_Z2R.dat");
    spline_Omega_Z3 = load_data(&Data_Omega_Z3, "./dat/Omega_Z3.dat");
    spline_Omega_P = load_data(&Data_Omega_P, "./dat/Omega_P.dat");
    spline_Omega_PH = load_data(&Data_Omega_PH, "./dat/Omega_PH.dat");
    spline_Omega_PH2 = load_data(&Data_Omega_PH2, "./dat/Omega_PH2.dat");
    spline_Omega_PR = load_data(&Data_Omega_PR, "./dat/Omega_PR.dat");
    spline_Omega_PRH = load_data(&Data_Omega_PRH, "./dat/Omega_PRH.dat");
    spline_Omega_PR2 = load_data(&Data_Omega_PR2, "./dat/Omega_PR2.dat");
    spline_Omega_PC = load_data(&Data_Omega_PC, "./dat/Omega_PC.dat");
    spline_Omega_PCH = load_data(&Data_Omega_PCH, "./dat/Omega_PCH.dat");
    spline_Omega_PCR = load_data(&Data_Omega_PCR, "./dat/Omega_PCR.dat");
    spline_Omega_P2 = load_data(&Data_Omega_P2, "./dat/Omega_P2.dat");
    spline_Omega_P2H = load_data(&Data_Omega_P2H, "./dat/Omega_P2H.dat");
    spline_Omega_P2R = load_data(&Data_Omega_P2R, "./dat/Omega_P2R.dat");
    spline_Omega_PC2 = load_data(&Data_Omega_PC2, "./dat/Omega_PC2.dat");
    spline_Omega_P2C = load_data(&Data_Omega_P2C, "./dat/Omega_P2C.dat");
    spline_Omega_P3 = load_data(&Data_Omega_P3, "./dat/Omega_P3.dat");
    spline_Omega_N = load_data(&Data_Omega_N, "./dat/Omega_N.dat");
    spline_Omega_NH = load_data(&Data_Omega_NH, "./dat/Omega_NH.dat");
    spline_Omega_NH2 = load_data(&Data_Omega_NH2, "./dat/Omega_NH2.dat");
    spline_Omega_NR = load_data(&Data_Omega_NR, "./dat/Omega_NR.dat");
    spline_Omega_NRH = load_data(&Data_Omega_NRH, "./dat/Omega_NRH.dat");
    spline_Omega_NR2 = load_data(&Data_Omega_NR2, "./dat/Omega_NR2.dat");
    spline_Omega_NZH = load_data(&Data_Omega_NZH, "./dat/Omega_NZH.dat");
    spline_Omega_NZR = load_data(&Data_Omega_NZR, "./dat/Omega_NZR.dat");
    spline_Omega_N2R = load_data(&Data_Omega_N2R, "./dat/Omega_N2R.dat");
    spline_Omega_CZ = load_data(&Data_Omega_CZ, "./dat/Omega_CZ.dat");
    spline_Omega_CZH = load_data(&Data_Omega_CZH, "./dat/Omega_CZH.dat");
    spline_Omega_CZH2 = load_data(&Data_Omega_CZH2, "./dat/Omega_CZH2.dat");
    spline_Omega_CZHp = load_data(&Data_Omega_CZHp, "./dat/Omega_CZHp.dat");
    spline_Omega_CZR = load_data(&Data_Omega_CZR, "./dat/Omega_CZR.dat");
    spline_Omega_CZRH = load_data(&Data_Omega_CZRH, "./dat/Omega_CZRH.dat");
    spline_Omega_C2Z = load_data(&Data_Omega_C2Z, "./dat/Omega_C2Z.dat");
    spline_Omega_C2ZH = load_data(&Data_Omega_C2ZH, "./dat/Omega_C2ZH.dat");
    spline_Omega_CZ2 = load_data(&Data_Omega_CZ2, "./dat/Omega_CZ2.dat");
    spline_Omega_CZ2H = load_data(&Data_Omega_CZ2H, "./dat/Omega_CZ2H.dat");
    spline_Omega_PZ = load_data(&Data_Omega_PZ, "./dat/Omega_PZ.dat");
    spline_Omega_PZH = load_data(&Data_Omega_PZH, "./dat/Omega_PZH.dat");
    spline_Omega_PZR = load_data(&Data_Omega_PZR, "./dat/Omega_PZR.dat");
    spline_Omega_PZC = load_data(&Data_Omega_PZC, "./dat/Omega_PZC.dat");
    spline_Omega_PZCH = load_data(&Data_Omega_PZCH, "./dat/Omega_PZCH.dat");
    spline_Omega_P2Z = load_data(&Data_Omega_P2Z, "./dat/Omega_P2Z.dat");
    spline_Omega_PZ2 = load_data(&Data_Omega_PZ2, "./dat/Omega_PZ2.dat");
    spline_Omega_NC = load_data(&Data_Omega_NC, "./dat/Omega_NC.dat");
    spline_Omega_NCH = load_data(&Data_Omega_NCH, "./dat/Omega_NCH.dat");
    spline_Omega_NCR = load_data(&Data_Omega_NCR, "./dat/Omega_NCR.dat");
    spline_Omega_NCZH = load_data(&Data_Omega_NCZH, "./dat/Omega_NCZH.dat");
    spline_Omega_NC2 = load_data(&Data_Omega_NC2, "./dat/Omega_NC2.dat");
    spline_Omega_PN = load_data(&Data_Omega_PN, "./dat/Omega_PN.dat");
    spline_Omega_PNH = load_data(&Data_Omega_PNH, "./dat/Omega_PNH.dat");
    spline_Omega_PNR = load_data(&Data_Omega_PNR, "./dat/Omega_PNR.dat");
    spline_Omega_PNC = load_data(&Data_Omega_PNC, "./dat/Omega_PNC.dat");
    spline_Omega_P2N = load_data(&Data_Omega_P2N, "./dat/Omega_P2N.dat");
}
// ... existing code ...
